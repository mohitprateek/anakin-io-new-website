      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted max-w-lg mx-auto">
            Paste any URL. See real results.
          </p>
        </motion.div>
                ...
                <div className="flex items-center justify-center h-[340px]">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Scraping{" "}
                      <span className="text-foreground font-[family-name:var(--font-jetbrains)]">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#0c0c0c]/80 to-[#0c0c0c] flex items-end justify-center pb-10">
                        <div className="text-center">
                          ...
                          <div className="flex flex-col sm:flex-row items-center gap-3">
                            ...
                            <button className="flex items-center gap-2 rounded-lg border border-border px-5 py-3 text-sm font-medium text-muted hover:text-foreground hover:border-muted-foreground transition-all">
                              <Github size={14} />
                              Sign up with GitHub
                            </button>
                          </div>
